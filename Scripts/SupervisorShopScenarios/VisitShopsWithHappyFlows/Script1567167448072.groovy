...
CustomKeywords.'qa.keywords.ShopVisitingScenariosKeywords.visitShopWith_HappyFlow'()
...
CustomKeywords.'qa.keywords.WorkActionsKeywords.selectAction'('Un-Captured')

Mobile.verifyElementExist(findTestObject('WorkActions/Validate_UncapturedVisit_Popup', [('package') : ProjectConstants.PACKAGENAME]), 
    0)

Mobile.tap(findTestObject('WorkActions/Uncapturedvisit_OkButton', [('package') : ProjectConstants.PACKAGENAME]), 0)

CustomKeywords.'qa.keywords.WorkActionsKeywords.validateShopListScreenForUnCapturedShops'()
...
CustomKeywords.'qa.keywords.WorkActionsKeywords.selectAction'('WR')
...
CustomKeywords.'qa.keywords.WorkActionsKeywords.selectSameRouteForDifferentWorkActions'(ProjectConstants.CURRENTVISITING_ROUTE)
...
CustomKeywords.'qa.keywords.WorkActionsKeywords.selectSubAction'('Un-Captured')
...
CustomKeywords.'qa.keywords.WorkActionsKeywords.selectAction'('Merchandising')
...
CustomKeywords.'qa.keywords.DisplayReportKeywords.displayDataInReport'()
