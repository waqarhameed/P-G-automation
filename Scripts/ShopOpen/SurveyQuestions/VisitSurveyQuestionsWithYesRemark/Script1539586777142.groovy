...
not_run: Mobile.verifyElementText(findTestObject('ShopOpen/SurveyQuestions/Validate_QuestionCategoryScreen', [('package') : ProjectConstants.PACKAGENAME]), 
    'Question Category')

CustomKeywords.'qa.keywords.__SurveyQuestions.visitSurveyQuestionCategories'(1)
